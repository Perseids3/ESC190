...
# BST is a tree where all values contained is comparable. All parent nodes are larger than their left children. 
# All parents nodes are smaller than their right chidren.
# Assume there are not same values stored. 
